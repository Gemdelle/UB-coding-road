...
def draw(frame, change_screen):
    ...
    user_completed_stage = user_progress["print"]["current"] > 3
    ...
    subtitle_label = WhiteStormLabel(title_frame, text=f'1.3. Coma → print(word,word)', font_size=16,
...
def correct_music_sheet(output_frame, code_frame, change_screen, input_area):
    ...
    next_level_button = tk.Button(code_frame, width=7, height=2, text="Next",
                                  command=lambda: change_screen(Screens.PRINT_4))
