...
def draw(frame, change_screen):
    ...
    task_label = WhiteStormLabel(task_frame,bg=task_frame.cget('bg'),font_size=13, width=60, height=5, text='❧ Consigna: Imprimir la frase "Please climb the tower fast" con una\npalabra en cada renglón utilizando un string\nformateado con y saltos de línea.')
