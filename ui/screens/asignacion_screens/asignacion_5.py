...
from utils.sound_manager import SoundManager, play_button_sound, play_correct_sound, play_wrong_sound
...
def draw(frame, change_screen):
    ...
    back_arrow_image = ClickableImage(title_frame, image_path=resource_path("assets\\images\\back_arrow.png"),
                                      ...
                                      bg=frame.cget('bg'))
    back_arrow_image.grid(row=0, column=user_progress["comentarios"]["total"] + 3, sticky='w', padx=(190, 0),
                          pady=(5, 0))
    ...
    book_image.grid(row=0, column=user_progress["comentarios"]["total"] + 3, sticky='w', padx=(310, 0), pady=(0, 0))
