...
def draw(frame, change_screen):
    ...
    title_label.grid(row=0, column=1, sticky='w', padx=(10, 0), pady=(0, 0))
    ...
    subtitle_label.grid(row=0, column=1, sticky='w', padx=(10, 0), pady=(70, 0))
    ...
    back_arrow_image = ClickableImage(title_frame, image_path=resource_path("assets\\images\\back_arrow.png"),
                                      ...
                                      bg=frame.cget('bg'))
    back_arrow_image.grid(row=0, column=user_progress["input"]["total"] + 3, sticky='w', padx=(480, 0),
                          pady=(5, 0))
    ...
    book_image.grid(row=0, column=user_progress["input"]["total"] + 3, sticky='w', padx=(600, 0), pady=(0, 0))
...
def correct_music_sheet(output_frame, code_frame, change_screen, input_area):
    ...
    next_level_button = tk.Button(code_frame, width=7, height=2, text="Next",
                                  command=lambda: (change_screen(Screens.INPUT_1), play_button_sound()))
